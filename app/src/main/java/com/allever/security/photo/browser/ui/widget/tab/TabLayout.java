 ...
 */
package com.allever.security.photo.browser.ui.widget.tab;
 ...
 * done through {@link TabLayout.Tab} instances. You create tabs via {@link #newTab()}. From there you can
 * change the tab's label or icon via {@link TabLayout.Tab#setText(int)} and {@link TabLayout.Tab#setIcon(int)}
 * respectively. To display the tab, you need to add it to the layout via one of the
 * {@link #addTab(TabLayout.Tab)} methods. For example:
 * <pre>
 * TabLayout tabLayout = ...;
 ...
 * </pre>
 * You should set a listener via {@link #setOnTabSelectedListener(TabLayout.OnTabSelectedListener)} to be
...
public class TabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        private void setTab(@Nullable final TabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
