...
//    public static final String BASIC_VIDEO_PATH = com.android.absbase.utils.FileUtil.getExternalCacheDir(App.getContext(),
//            "video", true);

//    public static final String BASIC_VIDEO_30_FILE_PATH = getBasicVideoPath() + File.separator + "emptyvideoframe30.mp4";
//
//    public static final String BASIC_VIDEO_50_FILE_PATH = getBasicVideoPath() + File.separator + "emptyvideoframe50.mp4";
